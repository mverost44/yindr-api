...
// { customer: { title: '', text: 'foo' } } -> { customer: { text: 'foo' } }
...
router.post('/customers', requireToken, (req, res, next) => {
  ...
  req.body.customer.owner = req.user.id
...
router.patch('/customer/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/customer/:id', requireToken, (req, res, next) => {
  Customer.findById(req.params.id)
    .then(handle404)
    .then(customer => {
